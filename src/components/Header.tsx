...
function Header() {
  ...
  const extraContent = (
    <div>
      <p className="text-white py-4 max-w-lg tl:text-xs text-md font-bold">
        ...
        <div className="wrapper flex justify-between items-center h-screen w-full px-20 lg:justify-center lg:px-6">
          <div className="content lg:text-center">
            <div className="btn py-3">
              <button className=" border-2 text-xl border-[#b0aaaa] font-bold text-white p-4 rounded-2xl bg-[radial-gradient(ellipse_at_bottom_right,_var(--tw-gradient-stops))] from-blue-700 via-blue-800 to-gray-900">
                Welcome to my website, I'm Anggih !!
              </button>
            </div>
            <p className="text-white py-4 max-w-lg tl:text-sm text-md font-bold">
